...
<label>
<span class="muted">Your idea / suggestion (anonymous)</span>
<textarea name="message" rows="5" required placeholder="Share an idea, request, or plan..."></textarea>
</label>
<label>
<span class="muted">Optional contact (email or handle)</span>
<input name="contact" type="text" placeholder="Only if you'd like a reply" />
</label>
